<script>
	...
	const addClimatic = async () => {
		...
		let response = await RestService.addClimatic(data);
		if (response['status']) {
		...
		>
			<div class="rounded-t mb-0 px-4 py-3 border-0">
				<div class="text-center flex justify-between">
					<h3 class="font-semibold text-lg text-blueGray-700">İklimlendirme Ekle</h3>
				</div>
			</div>
